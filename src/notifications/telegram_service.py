...
"""
    ...
    async def _handle_subscribe(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        if subscription_type not in ["signals", "trades", "all"]:
            await update.message.reply_text("❌ Invalid subscription type. Use: signals, trades, or all")
            return
...
"""
    ...
    def _is_authorized(self, user_id: int) -> bool:
        ...
        return user_id in self.authorized_users or user_id == self.settings.telegram_admin_id
