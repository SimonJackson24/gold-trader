...
tick_pool = MemoryPool(lambda: {'symbol': '', 'price': 0, 'timestamp': 0}, max_size=1000)
candle_pool = MemoryPool(lambda: {'open': 0, 'high': 0, 'low': 0, 'close': 0, 'volume': 0}, max_size=500)
signal_pool = MemoryPool(lambda: {'signal_id': '', 'direction': '', 'entry_price': 0}, max_size=200)