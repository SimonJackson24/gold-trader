...
class StructuredLogger:
    ...
    def measure_performance(self, operation: str):
        ...
        try:
            ...
            self.performance(
                f"Operation completed", operation=operation, duration_ms=duration_ms
            )
...
class SecurityLogger:
    ...
    def login_attempt(
        self, username: str, ip_address: str, success: bool, user_agent: str = None
    ):
        """
        Log login attempt.
        ...
        self.logger.set_context(
            user_id=username, ip_address=ip_address, user_agent=user_agent
        )
    ...
    def authentication_failure(
        self, reason: str, token: str = None, ip_address: str = None
    ):
        """
...
class AuditLogger:
    ...
    def trade_created(
        self, trade_id: str, user_id: str, symbol: str, direction: str, volume: float
    ):
        """
        Log trade creation.
        ...
        Args:
            ...
            volume: Trade volume
        """
        self.logger.set_context(user_id=user_id, trade_id=trade_id)
    ...
    def trade_closed(
        self, trade_id: str, user_id: str, reason: str, profit_loss: float
    ):
        """
        Log trade closure.
    ...
    def signal_generated(
        ...
        """
        self.logger.set_context(user_id=user_id, signal_id=signal_id)
    ...
    def configuration_change(
        self, user_id: str, key: str, old_value: str, new_value: str
    ):
        """
