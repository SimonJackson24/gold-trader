...
class MarketDataProcessor:
    ...
    async def _update_timeframe_candle(self, window: RollingWindow, tick: Tick,
                                      current_candle: Optional[Candle], period: timedelta) -> Optional[Candle]:
        """
    ...
    async def _generate_signal(self, analysis, current_price: Decimal) -> Optional[TradingSignal]:
        """
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'last_m15_update': self.last_m15_update.isoformat() if self.last_m15_update else None,
            'last_h1_update': self.last_h1_update.isoformat() if self.last_h1_update else None,
            'last_h4_update': self.last_h4_update.isoformat() if self.last_h4_update else None,
