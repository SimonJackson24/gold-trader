...
class FairValueGap:
    ...
    def __init__(self, gap_type: str, top_price: Decimal, bottom_price: Decimal,
                 start_candle: Candle, end_candle: Candle):
        """
        Initialize FVG.
    ...
    def calculate_strength(self, avg_volume: float, current_volume: float) -> float:
        ...
        # Combine strengths
        strength = (size_strength * 0.4) + (volume_strength * 0.3) + (wick_strength * 0.3)
    ...
    def is_filled(self, current_price: Decimal, tolerance_pips: Decimal = Decimal('2')) -> bool:
        """
    ...
    def get_price_level(self) -> PriceLevel:
        ...
        return PriceLevel(
            ...
            level_type=f"FVG_{self.type}_TOP" if self.type == FairValueGapType.BULLISH else f"FVG_{self.type}_BOTTOM",
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            'middle_candle': self.middle_candle.to_dict() if self.middle_candle else None,
...
class FairValueGapDetector:
    ...
    def detect_fvgs(self, candles: List[Candle], avg_volume: float = 0) -> List[FairValueGap]:
        """
    ...
    def _analyze_pattern(self, candles: List[Candle], avg_volume: float) -> Optional[FairValueGap]:
        """
    ...
    def get_active_fvgs(self, fvgs: List[FairValueGap], current_price: Decimal,
                       max_age_minutes: int = 240) -> List[FairValueGap]:
        """
    ...
    def validate_fvg_fill(self, fvg: FairValueGap, current_price: Decimal,
                        fill_candle: Optional[Candle] = None) -> bool:
        """
