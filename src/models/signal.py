...
class TradingSignal:
    ...
    def __post_init__(self):
        ...
        if not 0 < self.risk_percentage <= 5:
            raise ValueError(
                f"Risk percentage should be between 0 and 5, got {self.risk_percentage}"
            )
    ...
    def is_price_near_entry(
        self, current_price: Decimal, tolerance_pips: Decimal = Decimal("5")
    ) -> bool:
        """
