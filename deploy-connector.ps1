...
Write-Colored "║              GOLD TRADER MT5 CONNECTOR DEPLOYMENT SCRIPT                      ║" $CYAN
Write-Colored "║                    Windows One-Command Installer                             ║" $CYAN
Write-Colored "╚══════════════════════════════════════════════════════════════════════════════╝`n" $CYAN

# ============================================================================
# STEP 1: Check Python
# ============================================================================
Write-Colored "🐍 Step 1: Checking Python installation..." $BLUE
...
try {
    ...
    Write-Colored "✅ Python found: $pythonVersion" $GREEN
} catch {
...
# ============================================================================
Write-Colored "`n📦 Step 2: Installing Python dependencies..." $BLUE
...
# ============================================================================
Write-Colored "`n📁 Step 3: Creating connector directory..." $BLUE
...
Write-Colored "✅ Directory created: $connectorDir" $GREEN

# ============================================================================
# STEP 4: Generate Configuration
# ============================================================================
Write-Colored "`n⚙️  Step 4: Creating configuration..." $BLUE
...
Write-Colored "✅ Configuration saved to $connectorDir\.env" $GREEN

# ============================================================================
# STEP 5: Create Connector Script
# ============================================================================
Write-Colored "`n📝 Step 5: Creating connector script..." $BLUE
...
Write-Colored "✅ Connector script created" $GREEN

# ============================================================================
# STEP 6: Create Launcher Script
# ============================================================================
Write-Colored "`n🚀 Step 6: Creating launcher script..." $BLUE
...
Write-Colored "✅ Launcher script created (run-connector.bat)" $GREEN
...
Write-Colored "`n✅ Connector is ready to use!" $GREEN
Write-Host ""
