...
class TestSignal:
    ...
    def test_signal_creation(self, sample_signal):
        ...
        assert sample_signal.reasoning == "Smart Money Concepts analysis indicates bullish bias"
...
class TestCandle:
    ...
    def test_candle_upper_shadow(self, sample_candle):
        ...
        expected_shadow = sample_candle.high - max(sample_candle.open, sample_candle.close)
    ...
    def test_candle_lower_shadow(self, sample_candle):
        ...
        expected_shadow = min(sample_candle.open, sample_candle.close) - sample_candle.low
